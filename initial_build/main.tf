...
provider "proxmox" {
  ...
  pm_api_token_id = "dax@pam!dax_token"

  # this is the full secret wrapped in quotes. don't worry, I've already deleted this from my proxmox cluster by the time you read this post
  pm_api_token_secret = "f91733b7-8128-493d-8d52-7634213a3b75"
...
resource "proxmox_vm_qemu" "test_server" {
  ...
  # another variable with contents "ubuntu-cloudinit-template"
  ...
  ipconfig0 = "ip=192.168.9.1${count.index + 1}/24,gw=192.168.9.1"
